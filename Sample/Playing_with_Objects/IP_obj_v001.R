...
# Inspired by the book "data driven security", by Jay Jacobs & Bob Rudis (@hrbrmstr)
# Used following license: CC4.0 -- https://datadrivensecurity.info/blog/pages/license.html
ip2long <- function(ip) {
