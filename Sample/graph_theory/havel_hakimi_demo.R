...
# Based on Pseudo-code from "Graph Theory and its applicatioins", 3rd ed., J.L. Gross, J. Yellen, M. Anderson, Ed. CRC
...
# Testing it:
test_degrees_seq <- c(6,6,6,6,4,4,4)
...
test_degrees_seq <- c(6,6,6,6,4,4)
